...
TASK_TOOL_DESCRIPTION = """Launch a configured Xinbo subagent to handle an isolated task.
...
SUBAGENT_START_DESCRIPTION = """Start a configured Xinbo subagent asynchronously.
